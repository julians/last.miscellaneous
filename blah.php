<?php
    ...
    class API
    {
        static $url = "http://ws.audioscrobbler.com/2.0/";
        static $key = "9afd5e1e21b4d22c4ebbc269614559d9";
        
        static public function request ($args)
        {
            if (!$args) return null;
            ...
            $url = API::$url ."?". http_build_query($args);
